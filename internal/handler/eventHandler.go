...
func (h EventHandler) CreateEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&event); err != nil {
		...
		LogMethod("Create Event API Failed", r.Method, kontek.Value(domain.Key("waktu")).(time.Time), http.StatusBadRequest)
		return
	}
	...
	if err := h.EventUsecase.CreateEvent(event); err != nil {
		...
		LogMethod("Create Event API Failed", r.Method, kontek.Value(domain.Key("waktu")).(time.Time), http.StatusInternalServerError)
		return
	}
...
func (h EventHandler) GetEventByName(w http.ResponseWriter, r *http.Request) {
	...
	if strings.TrimSpace(eventName) == "" {
		w.WriteHeader(http.StatusBadRequest)
		json.NewEncoder(w).Encode(Response{Message: "Missing event Name", Status: http.StatusBadRequest})
	...
	if err != nil {
		...
		LogMethod("Get Event By Name API Failed", r.Method, kontek.Value(domain.Key("waktu")).(time.Time), http.StatusNotFound)
		return
	}
...
func (h EventHandler) UpdateEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.EventUsecase.UpdateEvent(event); err != nil {
		...
		LogMethod("Update Event API Failed", r.Method, kontek.Value(domain.Key("waktu")).(time.Time), http.StatusNotFound)
		return
	}
	// show it on response body
	w.WriteHeader(http.StatusOK)
...
func (h EventHandler) DeleteEvent(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.EventUsecase.DeleteEvent(eventId); err != nil {
		w.WriteHeader(http.StatusNotFound)
		json.NewEncoder(w).Encode(Response{Message: err.Error(), Status: http.StatusNotFound})
		LogMethod("Delete Event API Failed", r.Method, kontek.Value(domain.Key("waktu")).(time.Time), http.StatusNotFound)
		return
	}
	// show it on response body
	w.WriteHeader(http.StatusOK)
...
func (h EventHandler) GetAllEvents(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		LogMethod("Get All Events API Failed", r.Method, kontek.Value(domain.Key("waktu")).(time.Time), http.StatusNotFound)
		return
	}
	// show it on response body
	w.WriteHeader(http.StatusOK)
